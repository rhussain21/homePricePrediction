...
```{r, Exploratory Data Analysis Fig 3. and Fig 4., echo = FALSE, warning=FALSE, message= FALSE, fig.show='hold',fig.align='center',out.width="50%", fig.height= 4 }
...
```{r, Exploratory Data Analysis Fig 5 and Fig 6, echo = FALSE, warning=FALSE, message= FALSE, fig.show='hold',fig.align='center',out.width="50%", fig.height= 4 }
...
include_graphics('./images/BaseModel.png')
```
